...
data_root = '../dataset/SeaDronesSee_v2_balanced/'
dataset_type = 'CocoDataset'
metainfo = {
    'classes': ('swimmer', 'boat',
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file='annotations/instances_train_balanced_v2.json',
...
val_dataloader = dict(
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file='annotations/instances_val_balanced_v2.json',
...
val_evaluator = dict(ann_file=data_root + 'annotations/instances_val_balanced_v2.json', classwise=True)
